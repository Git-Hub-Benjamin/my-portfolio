...
const Contact = () => {
 return (
   <section id="contact" className="p-6 bg-white scroll-mt-16">
     <div className="max-w-4xl mx-auto">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
         <a 
           ...
           className="flex items-center gap-3 p-4 bg-gray-50rounded-lg shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 hover:bg-gray-50"
         >
